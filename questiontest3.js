...
describe('Test question flow 3', function () {
   it('checking the if going back to previous menu', async function () {
    ...
    questionHelperStub.onCall(3).resolves(2);
    questionHelperStub.onCall(4).resolves(3);
    questionHelperStub.onCall(5).resolves(1);
    questionHelperStub.onCall(6).resolves(1);
    questionHelperStub.onCall(7).resolves(2);
